          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown active">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="#">The Brotherhood</a></li>
      ...
      <div class="accentBox">
          ...
          <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 subBox">
                    <a class="image-popup-zoom" href="../images/manicures2.jpg" >
                            <img class="img-rounded" src="../images/manicures2.jpg">
                          </a>      
    ...
    <div class="container brotherhood">
        <div class="row">
            ...
            <div class="col-sm-4 factside ">
                <a class="btn btn-primary btn-lg btn-side" href="#" role="button">Fast Facts</a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Fall 2015 Chapter Roster</h4>
                          </div>
...
?>
                ...
                <a href="http://phimudelta.publishpath.com/chapters-colonies" target="_blank"><button type="button" class="btn btn-primary btn-lg btn-side">Other Chapters</button></a>
            </div>
        </div>   
            </div>
      </div>
